...
ENV MQTT_HOST=127.0.0.1 MQTT_PORT=1883 MQTT_USERNAME="" MQTT_PASSWORD="" MQTT_RETAIN="True" MQTT_TOPIC=rtl_433 PROTOCOL="" WHITELIST_ENABLE=False EXPIRE_AFTER=0 WHITELIST="" DISCOVERY_PREFIX=homeassistant DISCOVERY_INTERVAL=600 DEBUG=False LANG=C.UTF-8

LABEL Maintainer="HalideGlow" \
